...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data_file", type=str, help="Path to dataset", default="../Datasets/SICK.tsv")
    ...
    parser.add_argument("-l", "--max_len", type=int, help="Maximum number of words in a sentence (0 for no limit)", default=20)
    ...
    print('Reading Data.')
    data = Data(args.data_file, args.max_len)
    ...
    embedding = Get_Embedding(data.word_to_id, vocab_size)
    ...
    embed_layer = Embedding(output_dim=embedding_size, input_dim=vocab_size, input_length=max_len, trainable=False)
